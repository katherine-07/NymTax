...
public interface NymtaxListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link NymtaxParser#data_type}.
	 * @param ctx the parse tree
	 */
	void enterData_type(NymtaxParser.Data_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link NymtaxParser#data_type}.
	 * @param ctx the parse tree
	 */
	void exitData_type(NymtaxParser.Data_typeContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterList_constants(NymtaxParser.List_constantsContext ctx);
	/**
	 * Exit a parse tree produced by {@link NymtaxParser#list_constants}.
	 * @param ctx the parse tree
	 */
	void exitList_constants(NymtaxParser.List_constantsContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterBool_term(NymtaxParser.Bool_termContext ctx);
	/**
	 * Exit a parse tree produced by {@link NymtaxParser#bool_term}.
	 * @param ctx the parse tree
	 */
	void exitBool_term(NymtaxParser.Bool_termContext ctx);
	/**
